...
weapons!(
    // Test items
    TEST_SWORD, SHOP_TEST_SWORD, 0, Weapon::new("Test Sword", 25.0, 0.8, 1.0, WeaponType::MeleeArea, time(0.5), time(0.2), None);
    ...
    UNARMED, SHOP_UNARMED, 0, Weapon::new("Unarmed", 15.0, 3.0, 1.0, WeaponType::MeleeLine, time(0.3), time(0.15), None);
