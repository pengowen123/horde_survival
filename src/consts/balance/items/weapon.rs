...
weapons!(
    ...
    TEST_BOW, SHOP_TEST_BOW, 0, Weapon::new("Test Bow", 60.0, 1.5, 0.8, WeaponType::RangedProjectile, None);
    TEST_WAND, SHOP_TEST_WAND, 0, Weapon::new("Test Wand", 45.0, 0.05, 1.2, WeaponType::RangedLinear, None);
