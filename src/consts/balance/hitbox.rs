...
pub fn get_hitbox(entity_type: &EntityType, coords: &Coords) -> Hitbox {
    let (mut a, mut b) = match *entity_type {
        EntityType::Player => (Point3::new(-0.12f64, -0.8, -0.12), Point3::new(0.12f64, 0.0, 0.12)),
        EntityType::Zombie => (Point3::new(-0.12f64, -0.8, -0.12), Point3::new(0.12f64, 0.0, 0.12)),
...
pub fn get_entity_box_size(entity_type: &EntityType) -> f32 {
    match *entity_type {
        ...
        EntityType::Zombie => 0.1,
        EntityType::FlyingBallLinear => 0.05,
